...
if __name__ == '__main__':
    ...
    ProcessingPlan.adjust_change_knife_time(data)
    data.combine_cells()
    data.merge_column_names()
    total_time = ProcessingPlan.compute_total_time(data)
    total_time_for_each_delivery_time_dict = ProcessingPlan.compute_total_time_for_each_delivery_time(data)
    print(f'总生产时间: {total_time}')
    print(total_time_for_each_delivery_time_dict)       
